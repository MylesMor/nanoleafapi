...
__05/01/20__: As of package version `1.0.5`, the bug described in issue #1 relating to the function `set_effect()` has been resolved.
...
__29/04/20__: As of package version `1.1.1`, the bug described in issue #4 by [vadichi](https://github.com/vadichi) relating to the function `discover_devices()` in the `discovery` module has been resolved.
